...
\begin{table}[ht]
    ...
    \begin{flushleft}
        \footnotesize
        PILS = Parallel Imaging with Localized Sensitivities\cite{griswoldPartiallyParallelImaging2000} \\
        LLR = Local Low Rank constrained reconstruction\cite{haldarLowrankApproximationsDynamic2011} \\
...
\begin{table}[ht]
    ...
    \begin{flushleft}
        \footnotesize
        For continuous data, values are expressed as mean $\pm$ SD and data ranges are in parentheses. For categorical data, values are expressed as numerators with percentage in parentheses. \\
...
\begin{table}[ht]
    ...
    \begin{flushleft}
        \footnotesize
        All values expressed as: mean $\pm$ standard deviation \\
