...
\begin{table}[ht]
    \centering
    \caption[C reconstructed parameters]{Reconstruction parameters for Cartesian, radial low-res, and radial hi-res 2D phase contrast scans.}\label{tab:recon_params}
    \begin{tabular}{lccc}
    \toprule
